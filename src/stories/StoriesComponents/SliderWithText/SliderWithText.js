...
function Slider({slider,backgroundColor,color,SliderAlt,TextOneColor,TextTwoColor}) {
    ...
    return (
        ...
        <div className="SliderWithText">
            ...
            <button id="goLeft"  onClick={goLeft} style={{backgroundColor:backgroundColor}}><p style={color && {color}}>&#60;</p></button>
            <button id="goRight" onClick={goRight} style={{backgroundColor:backgroundColor}}><p style={color && {color}}>&#62;</p></button>
        </div>
...
Slider.defaultProps = {
    ...
    SliderImg:"https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885_960_720.jpg",
    SliderAlt:"https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885_960_720.jpg",
