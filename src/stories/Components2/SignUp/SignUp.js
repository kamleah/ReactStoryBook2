    ...
    return (
        <div className="signUp">
            <div className="topContent">
                <h1><Label  labelFor="Sign UP" text="Sign UP" /></h1>
                <span><p>Already have account?<Linked to="abc.com" LinkLabel="Log In"/></p></span>
            </div>
            ...
            <div className="bottomContent">
                <p>*By signing up you are agree to our terms of Use and to <br></br> reciev emails and updates and acknowwleddge that you react our terms and policy.  </p>
            </div>
        </div> 
    )
}
